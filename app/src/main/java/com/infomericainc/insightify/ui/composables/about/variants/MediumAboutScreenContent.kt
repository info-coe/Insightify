package com.infomericainc.insightify.ui.composables.about.variants
...
@Composable
fun MediumAboutPolicyScreenContent(
...
@Composable
private fun MediumAboutScreenContentPreview() {
    InsightifyTheme {
        Surface {
            MediumAboutPolicyScreenContent(
                paddingValues = PaddingValues()
            )
        }
    }
