package com.infomericainc.insightify.ui.composables.recentorders.components.medium
...
fun MediumPendingScreen(
    ...
    LazyColumn(
        ...
        stickyHeader {
            Text(
                text = "Your order is in queue. We'll notify\nyou once it's accepted.",
                fontFamily = poppinsFontFamily,
...
@Composable
private fun MediumPendingScreenPreview() {
    Column(
        modifier = Modifier
            .fillMaxSize()
    ) {
