package com.infomericainc.insightify.ui.composables.splash.variants
...
fun CompactSplashScreen(
    ...
    val isLoggedIn by remember {
        mutableStateOf(preferencesManager.getBoolean(Constants.IS_USER_LOGGED_IN, false))
    }
    ...
    LaunchedEffect(Unit) {
        analytics.logEvent(FirebaseAnalytics.Event.SCREEN_VIEW) {
            param(FirebaseAnalytics.Param.SCREEN_NAME, "splash_screen_compact")
        }
    }
...
@Composable
private fun CompactSplashScreenPreview() {
    InsightifyTheme {
        Surface {
            CompactSplashScreen(
                paddingValues = PaddingValues(),
