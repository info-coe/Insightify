...
import com.infomericainc.insightify.ui.composables.settings.SettingsScreen

data object SettingsScreenSpec : ProfileSpec {
    override val route: String
        get() = ProfileScreens.SettingsScreen.route
