package com.infomericainc.insightify.ui.composables.login.variants
...
import com.infomericainc.insightify.ui.components.dialog.InstfyPermissionDialog
...
fun CompactLoginScreenContent(
    ...
    LaunchedEffect(
        ...
        when {
            ...
            userRegistrationUiState.userDataDto.userId != null -> {
                ...
                preferencesManager.saveBoolean(key = Constants.IS_USER_LOGGED_IN, true)
    ...
    if (showConsetDialog) {
        InstfyPermissionDialog(
            permissionIcon = Icons.Rounded.CloudUpload,
    ...
    Column(
        ...
        Text(
            text = "Let's sign you in to explore wide range of food options specially made for you.",
            fontFamily = poppinsFontFamily,
