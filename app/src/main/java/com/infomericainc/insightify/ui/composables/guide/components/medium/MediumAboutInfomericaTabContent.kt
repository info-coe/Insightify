package com.infomericainc.insightify.ui.composables.guide.components.medium
...
@Composable
fun MediumAboutInfomericaTabContent(
    ...
    LazyColumn(
        ...
        item {
            LazyRow(
                modifier = Modifier
                    ...
                    .fillMaxWidth()
                    .heightIn(
                        max = dimensionResource(id = com.intuit.sdp.R.dimen._50sdp)
                    )
        ...
        item {
            Text(
                ...
                lineHeight = dimensionResource(id = com.intuit.ssp.R.dimen._13ssp).value.sp
            )
        }
        ...
        item {
            Column(
                ...
                Icon(
                    imageVector = Icons.Rounded.Money, contentDescription = "", modifier = Modifier
                        .size(
                            dimensionResource(id = com.intuit.sdp.R.dimen._15sdp)
                        )
                )
