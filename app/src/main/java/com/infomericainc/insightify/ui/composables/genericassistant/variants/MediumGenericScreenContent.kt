...
import com.infomericainc.insightify.ui.composables.genericassistant.components.medium.MediumAssistantConversationMessage
import com.infomericainc.insightify.ui.composables.genericassistant.components.medium.MediumEmptyConversationPlaceHolder
import com.infomericainc.insightify.ui.composables.genericassistant.components.medium.MediumRestrictionBottomSheetContent
import com.infomericainc.insightify.ui.composables.genericassistant.components.medium.MediumTTSBottomSheetContent
import com.infomericainc.insightify.ui.composables.genericassistant.components.medium.MediumTypingProgressPlaceHolder
...
fun MediumGenericAssistantScreenContent(
    ...
    AnimatedVisibility(isConversationLimitReached) {
        ModalBottomSheet(
            ...
            MediumRestrictionBottomSheetContent(
                navController = navController
            )
        }
    }
                ...
                Column(
                    ...
                    Row(
                        ...
                        Row(
                            modifier = Modifier
                                ...
                                .fillMaxWidth(.85f)
                                .heightIn(
                                    min = dimensionResource(id = com.intuit.sdp.R.dimen._30sdp)
                                )
                                .clip(CircleShape)
                    ...
                    Text(
                        ...
                        modifier = Modifier
                            ...
                            .alpha(.6f),
                        fontSize = dimensionResource(id = com.intuit.ssp.R.dimen._6ssp).value.sp,
                        lineHeight = dimensionResource(id = com.intuit.ssp.R.dimen._8ssp).value.sp,
                        fontFamily = poppinsFontFamily,
