...
@Composable
fun CompactPaymentSuccessScreen(
                ...
                modifier = Modifier
                    .size(
                        if (showOptions) dimensionResource(
                            id = com.intuit.sdp.R.dimen._150sdp
                        ) else dimensionResource(id = com.intuit.sdp.R.dimen._250sdp)
                    )
                    .animateItem(
...
@Composable
private fun CompactPaymentSuccessScreenPreview() {
    InsightifyTheme {
        Surface {
            CompactPaymentSuccessScreen()
        }
    }
}