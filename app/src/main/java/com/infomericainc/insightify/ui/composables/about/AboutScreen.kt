package com.infomericainc.insightify.ui.composables.about
...
fun AboutScreen(
    ...
    AboutScreenBody(navController) { paddingValues ->
        CalculateWindowSize(
            windowWidthSizeClass = windowWidthSizeClass,
            compactContent = {
                CompactAboutScreenContent(paddingValues = paddingValues)
            },
            mediumContent = {
                MediumAboutPolicyScreenContent(paddingValues = paddingValues)
            },
            unSupportedContent = {
