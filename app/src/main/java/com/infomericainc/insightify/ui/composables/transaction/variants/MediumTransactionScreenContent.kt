package com.infomericainc.insightify.ui.composables.transaction.variants
...
@Composable
fun MediumTransactionScreenContent(
...
@Preview
@Composable
private fun MediumTransactionScreenContentPreview() {
    InsightifyTheme {
        Surface {
