...
import com.infomericainc.insightify.ui.composables.profileCustomization.components.MediumProfileCustomizationItem
...
@Composable
fun MediumProfileCustomizationContent(
    ...
    LazyColumn(
        ...
        item {
            MediumProfileCustomizationItem(
...
@Composable
private fun MediumProfileCustomizationContentPreview() {
    InsightifyTheme {
        Surface {
            MediumProfileCustomizationContent(
                ...
                userProfileUIState = ProfileUIState(
                    userProfileDto = UserProfileDto(
                        username = "Bharadwaj Ravinuthala sdkjhfksdhfksdhfkhsjd",
                        email = "bharadwaj@infomericainc.com"
                    )
                )
            )
        }
