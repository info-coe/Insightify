...
@Composable
fun MediumRestrictionBottomSheetContent(
...
@Composable
private fun MediumRestrictionBottomSheetContentPreview() {
    InsightifyTheme {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            MediumRestrictionBottomSheetContent(rememberNavController())
        }
    }
}