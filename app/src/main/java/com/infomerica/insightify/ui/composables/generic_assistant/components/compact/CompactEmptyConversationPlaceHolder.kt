...
@Composable
fun CompactEmptyConversationPlaceHolder() {
    Column(
        modifier = Modifier
            .padding(
                horizontal = dimensionResource(id = R.dimen._30sdp),
        ...
        Text(
            ...
            fontSize = dimensionResource(id = com.intuit.ssp.R.dimen._18ssp).value.sp,
            modifier = Modifier.padding(bottom = dimensionResource(id = R.dimen._25sdp)),
            style = TextStyle(
